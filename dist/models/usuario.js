                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new Promise(function (resolve, reject) {
                            bcrypt.genSalt(10, function (err, salt) {
                                bcrypt.hash(_this.senha, salt, null, function (erro, hash) {
                                    if (erro)
                                        reject(erro);
                                    resolve(hash);
                                });
                            });
                        }).then(function (result) { return _this.senha = result.toString(); })
                            .catch(function (err) { return new restify_errors_1.BadRequestError().statusCode; })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
