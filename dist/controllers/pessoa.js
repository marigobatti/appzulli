...
var pessoa_1 = require("../service/pessoa");
var PessoaController = /** @class */ (function () {
    function PessoaController() {
    }
    PessoaController.prototype.initialize = function (httpServer) {
    ...
    PessoaController.prototype.list = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = res).send;
                        return [4 /*yield*/, pessoa_1.pessoaService.list()];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [2 /*return*/];
                }
    ...
    PessoaController.prototype.getById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var usuario;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, pessoa_1.pessoaService.getById(req.params.id)];
                    case 1:
                        usuario = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = res).send;
                        return [4 /*yield*/, pessoa_1.pessoaService.create(req.body)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [2 /*return*/];
                }
    ...
    PessoaController.prototype.remove = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var pessoa;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, pessoa_1.pessoaService.delete(req.params.id)];
                    case 1:
                        pessoa = _a.sent();
